        ...
        <div class="row" style='Height: 300px'>
            <div class=" mt-5 col-12 staff_col">
                ...
                <form action="../staff/staff_add_phim.php" method="get">
                    <button type="submit" class="btn  staff-add" style="margin-top :10px; margin-bottom: 10px"><i class="fas fa-plus-circle"></i>
                        Thêm phim</button>
                        </form>
                </div>
...
<section class="Cancel"
    ...
    <div class="cancel-container"
        style="background-color: #fff;height: 145px;margin-left: 40%;margin-right: 40%;padding-bottom: 100px;border-radius: 10px;margin-top: 20%;">
        <div class="row">
            ...
            <button type="submit" class="js_yes btn btn-primary staff-add "
                style="margin-left: 80px;width: 60px;margin-right: 20px;">Có</button>
