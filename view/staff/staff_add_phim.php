            ...
            <div class="row">
                <div class="col-10" style="margin-left: 300px;margin-top: 20px; margin-bottom: 20px;">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <button class=" js_addinf btn me-md-2 staff-add  " style="width: 140px; margin: 8px;margin-left: -38px;" type="button">Xác nhận</button>

                        <form action="../staff/staff_inf_phim.php" method="get">
                            <button class="btn staff-add " style="width: 140px; margin: 8px;" type="submit">Quaylại</button>
                        </form>
                    </div>
                </div>
            </div>
