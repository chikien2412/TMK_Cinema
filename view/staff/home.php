    ...
    <div class=" container height-100 bg-light">
        <div class=" col py-3 ">
            <div class="container-fluid ">
                <div class="row mt-3 pt-3 product_heading" >
            ...
            <div class="container-fluid py-3 " style="width:100% ; overflow: auto; height: auto;">
                <div class="row">
                    <div class="py-2">
                    <br><br><br>   
                    <button type="button" class="btn product_view d-block" style="width: 170px" >
                        <a href="add.php"><i class="fas fa-user-plus"></i>Thêm khách hàng </a>
                        </button>
</br></br></br>
